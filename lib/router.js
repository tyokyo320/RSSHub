...
router.get('/bilibili/user/bangumi/8366997/:type?', lazyloadRouteHandler('./routes/bilibili/user_bangumi'));
...
// AGE动漫
router.get('/agefans/detail/20210070', lazyloadRouteHandler('./routes/agefans/detail'));
